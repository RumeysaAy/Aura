...
#include "GameplayTagsManager.h" // oyun etiketine erişmek için

FAuraGameplayTags FAuraGameplayTags::GameplayTags;

void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	// oyun etiketlerini başlatacağım yani etiketleri oluşturacağım
	// oyun etiketi yöneticisi
	// Bir oyun etiketi oluşturduğumda, bu oyun etiketi yöneticisine kaydedilir.
	...
	// etiketin adı, yorumu (bu etiketi Attributes_Secondary_Armor değişkeninde sakladım)
	...
	*/
	...
	// etiketin adı, yorumu (bu etiketi InputTag_LMB değişkeninde sakladım)
