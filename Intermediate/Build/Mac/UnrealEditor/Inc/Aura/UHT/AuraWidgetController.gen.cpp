...
template<> AURA_API UScriptStruct* StaticStruct<FWidgetControllerParams>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAuraWidgetController_BroadcastInitialValues_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "// bu i\xc5\x9flevi devralan herhangi bir widget denetleyicisi, kendi benzersiz ba\xc5\x9flang\xc4\xb1\xc3\xa7 de\xc4\x9f""erini yay\xc4\xb1nlayabilecek\n" },
#endif
		{ "ModuleRelativePath", "Public/UI/WidgetController/AuraWidgetController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "bu i\xc5\x9flevi devralan herhangi bir widget denetleyicisi, kendi benzersiz ba\xc5\x9flang\xc4\xb1\xc3\xa7 de\xc4\x9f""erini yay\xc4\xb1nlayabilecek" },
#endif
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAuraWidgetController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAuraWidgetController_BroadcastInitialValues, "BroadcastInitialValues" }, // 2561024908
	...
	struct Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAuraWidgetController, UAuraWidgetController::StaticClass, TEXT("UAuraWidgetController"), &Z_Registration_Info_UClass_UAuraWidgetController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAuraWidgetController), 995798568U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_4030806379(TEXT("/Script/Aura"),
		Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_rumeysaay_Documents_Unreal_Projects_Aura_Source_Aura_Public_UI_WidgetController_AuraWidgetController_h_Statics::ScriptStructInfo),
		nullptr, 0);
